...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // register logical Volume in PolarizationManager with polarization in the direction of beam
...
void DetectorConstruction::SetTargetPolarizationZ(G4double value)
{
    fTargetPolarization = value;
    G4PolarizationManager* polMgr = G4PolarizationManager::GetInstance();
    polMgr->SetVolumePolarization("theBox", G4ThreeVector(0., 0., value));
    G4cout << "Set Z polarization of targret to " << value << "\n";
}
